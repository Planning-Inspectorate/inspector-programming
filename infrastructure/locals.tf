locals {
  ...
  tech_emails = [for rec in azurerm_monitor_action_group.scheduling_tech.email_receiver : rec.email_address]
  action_group_ids = {
    tech            = azurerm_monitor_action_group.scheduling_tech.id
    service_manager = azurerm_monitor_action_group.scheduling_service_manager.id
