...
import { SPECIAL_CIRCUMSTANCES } from '../../database/src/seed/special-circumstances.js';
...
export function filterCases(cases, filters) {
	...
	if (filters.specialCircumstances) {
		...
		const circumstanceExclusions = {
			...
			[SPECIAL_CIRCUMSTANCES.EXCLUDE_DESIGNATED_SITES]: (c) => c.designatedSitesNames === null
		};
