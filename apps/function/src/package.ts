...
async function replaceLocalPackages() {
	...
	for (const srcFile of srcFiles) {
		await replaceInFile(srcFile, [
			{ replace: '@pins/inspector-programming-lib', with: '#pins/inspector-programming-lib' },
			{ replace: '@pins/inspector-programming-database', with: '#pins/inspector-programming-database' }
		]);
	}
}
